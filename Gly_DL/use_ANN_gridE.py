        ...
        class LossHistory(Callback):  # 继承自Callback类
            ...
            def on_epoch_end(self, batch, logs={}):
                ...
                if self.e in [32]:
                    ...
                    self.val_pre_score[0].append(self.y_val)
                    self.val_pre_score[1].append(y_pred)
                    self.val_pre_score[2].append(yy_pred)
...
if __name__ == '__main__':
    ...
    train_dir = '/mnt/raid5/data4/publice/gly_site_pred/bert_fea/'
